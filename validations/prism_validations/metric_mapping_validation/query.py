def get_query(model_names=None):
    ...
    EXIST_REV_LOGIC AS (
        SELECT
            ...
            IIF(FORM_DEPLOYED_PROFILE.ProjectPointID IS NOT NULL, 'YES', 'NO') AS [INCLUDED IN PROFILE],
    ...
    COMBINED_LOGIC AS (
        SELECT [FORM ID], [FORM NAME], [METRIC ID], [METRIC NAME], [POINT NAME], [POINT DESCRIPTION], [POINT UNIT], [CONSTRAINED POINT], [FUNCTION], [POINT TYPE], [FORM TYPE], [DEPLOYED], [THRESHOLD TYPE], [INCLUDED IN PROFILE] FROM EXIST_REV_LOGIC
        UNION
        SELECT [FORM ID], [FORM NAME], [METRIC ID], [METRIC NAME], [POINT NAME], [POINT DESCRIPTION], [POINT UNIT], [CONSTRAINED POINT], [FUNCTION], [POINT TYPE], [FORM TYPE], [DEPLOYED], [THRESHOLD TYPE], [INCLUDED IN PROFILE] FROM NON_EXIST_REV_LOGIC
    )
    SELECT
        x.[FORM NAME], x.[METRIC NAME], x.[POINT NAME], x.[POINT DESCRIPTION], x.[POINT UNIT], x.[FUNCTION], x.[POINT TYPE], x.[INCLUDED IN PROFILE]
